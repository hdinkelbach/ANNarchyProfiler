    ...
    def recalc_mean_values(self, obj_type, name, func, factor):
        ...
        for i in range(len(mean_values)):
            ...
            for n in range(len(raw_data[i])):
                if raw_data[i][n] <= (
                    mean_values[i] + factor * std_values[i]
                ) and raw_data[i][n] >= (mean_values[i] - factor * std_values[i]):
